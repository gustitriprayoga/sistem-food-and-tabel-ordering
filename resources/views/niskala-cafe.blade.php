        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-5 col-md-6 reveal" style="transition-delay: 0.2s;">
                <div class="custom-card p-4 h-100 d-flex flex-column text-center">
                    ...
                    <p class="text-muted flex-grow-1">Amankan spot terbaik Anda untuk tanggal dan waktu yang spesifik,
                        cocok untuk acara khusus.</p>
            ...
            <div class="col-lg-5 col-md-6 reveal" style="transition-delay: 0.4s;">
                <div class="custom-card p-4 h-100 d-flex flex-column text-center">
                    ...
                    <p class="text-muted flex-grow-1">Pesan makanan dan minuman terbaik kami, bisa untuk *takeaway* atau
                        *dine-in* dengan memilih meja yang tersedia.</p>
                    <a href="{{ route('menu.index') }}" class="btn btn-outline-light mt-3" style="border-radius: 50px;">
                        Lihat Menu &rarr;
                    </a>
                </div>
            </div>
...
<section class="py-5 bg-secondary mt-5">
    <div class="container text-center reveal">
        <h2 class="ff-serif text-light mb-3">Lihat Menu atau Amankan Tempat Duduk?</h2>
        <p class="lead text-muted mb-4">Pilih langkah Anda selanjutnya di Niskala Cafe.</p>

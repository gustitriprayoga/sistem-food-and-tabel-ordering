            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center wow fadeInUp">
                        <h2 class="s1 mb-40">Make a</h2>
                        <h2 class="s2">Reservation</h2>
                        <ol class="breadcrumb">
    ...
    <div id="content" class="no-bottom no-top">
        <section id="section-book-form">
            <div class="container">
                <div class="row gx-5">
                    <div class="col-lg-4">
                        <h3 class="s2 id-color">Booking now!</h3>
                        <p>Simply select your desired date, time, and party size, and leave the rest to us. Get ready to
                            indulge in exquisite flavors, impeccable service, and unforgettable moments as you embark on a
                            culinary journey like no other. </p>
                    </div>
                    <div class="col-lg-8">

...
<head>
  ...
  <!-- Favicon icon-->
  <link rel="shortcut icon" type="image/png" href="{{ asset('backend/dist/assets/images/logos/favicon.png') }}" />

  <!-- Core Css -->
  <link rel="stylesheet" href="{{ asset('backend/dist/assets/css/styles.css') }}" />

  <title>Sistem Pemesanan Menu Dan Meja</title>
</head>

<body>
  <!-- Preloader -->
  <div class="preloader">
    <img src="{{ asset('backend/dist/assets/images/logos/favicon.png') }}" alt="loader" class="lds-ripple img-fluid" />
  </div>
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <div class="position-relative text-center my-4">
                  <p class="mb-0 fs-4 px-3 d-inline-block bg-body text-dark z-index-5 position-relative">Selamat Datang
                    Kembali
                  </p>
                ...
                <form method="POST" action="{{ route('login.post') }}">
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="form-check">
                      <input class="form-check-input primary" type="checkbox" value="" id="rememberDevice" name="rememberDevice" checked>
